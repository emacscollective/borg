...
- Function: borg-initialize
  ...
  This function initializes assimilated drone using ~borg-activate~.
...
If building does fails, then a buffer containing information about the
...
- Command: borg-assimilate name url

  This command assimilates the drone named NAME from URL.
...
- Command: borg-remove clone
  ...
  This command remove the cloned or assimilated package named CLONE,
